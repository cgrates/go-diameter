...
func TestPrepareSupportedAppsWithSuppApps(t *testing.T) {
	...
	rcvLst := PrepareSupportedApps(parser, []string{"Charging Control", "1",
		"TGPP.TGPP S6A"})
...
func TestPrepareSupportedAppsNoSuppApps(t *testing.T) {
	var testDicts = []string{
		"../dict/testdata/base.xml",
		"../dict/testdata/credit_control.xml",
		"../dict/testdata/network_access_server.xml",
